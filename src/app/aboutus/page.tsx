...
export default function aboutus() {
  return (
    ...
    <div className="2xl:container min-h-screen 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
    ...
    <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
        ...
        <div className="w-full lg:w- red lg:pt-8">
            <div className="grid md:grid-cols-5 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                <div className="p-4 pb-6 flex justify-center flex-col items-center">
                    <img className="" src="./Anass_Bsela.jpg" alt="Alexa featured Image" />
                    <p className="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Anass bsela</p>
                </div>
                <div className="p-4 pb-6 flex justify-center flex-col items-center">
                    <img className="" src="./sixie.jpeg" alt="Olivia featured Image" />
                 
                    <p className="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Olivia</p>
                </div>
                <div className="p-4 pb-6 flex justify-center flex-col items-center">
                    <img className="" src="https://i.ibb.co/Pc6XVVC/Rectangle-120.png" alt="Liam featued Image" />

                    <p className="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Liam</p>
                </div>
                <div className="p-4 pb-6 flex justify-center flex-col items-center">
                    <img className="" src="https://i.ibb.co/7nSJPXQ/Rectangle-121.png" alt="Elijah featured image" />
